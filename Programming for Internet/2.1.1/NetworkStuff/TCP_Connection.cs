...
{
    public abstract class TCP_Connection : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new <see cref="TCP_Connection"/> with the provided endpoint information
        /// </summary>
        /// <param name="ipAddress">Remote address of the connection.</param>
        /// <param name="port">Remote port of the connection.</param>
        protected TCP_Connection(IPAddress ipAddress, int port) : this(new IPEndPoint(ipAddress, port))
        {
        }
        ...
        protected TCP_Connection(IPEndPoint endpoint) 
        {
            _endPoint = endpoint;
        ...
        protected TCP_Connection(Socket socket) 
        {
